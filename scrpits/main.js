...
(function(module) {
  ...
  mainPage.buildMarker = function(place) {
    ...
    for (var i = 0; i < ordSearchResults.length; i++) {
      ...
      let linkAddress = '<a href="https://www.google.com/maps/dir/?api=1&origin='+ pos.lat + ',' +pos.lng + '&destination=' + ordSearchResults[i].name + '&destination_place_id=' + ordSearchResults[i].id + '&travelmode=walking">View on Google Maps</a>'
